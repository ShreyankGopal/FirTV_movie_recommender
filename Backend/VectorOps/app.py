...
#      # 1️⃣ Fetch weather & slot (external module)
#      weather_api_key = "723f50afcd9786d87ed04d170ae22506"
#      cond, slot = get_weather_and_slot(lat, lon, weather_api_key)
#      # 2️⃣ Map to genre scores (tuples of (genre, score))
#      genres = weather_time_to_genres.get((cond, slot),
#      weather_time_to_genres.get((cond, "day"), []))
#      print(genres)
#     # Build the string for embedding (e.g. "Happy 0.5 Uplifting 0.3")
#      genre_str = " ".join([f"{genre} {score}" for genre, score in genres])
#      print("IN weather:",genre_str)
...
#         "time_slot": slot,
#     # Now unpack tuples correctly:
#         "genres": [
#             {"genre": genre, "score": round(score, 3)}
