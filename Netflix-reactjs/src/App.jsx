...
// import WeatherRecommendationDisplay from "./Pages/WeatherRecommendationDisplay";
// import PlaySharedMovie from "./Pages/PlaySharedMovie";
// function App() {
//   const { User, setUser } = useContext(AuthContext);
...
//               <Route path="/profile" element={<Profile />} />
//               <Route path="/mylist" element={<MyList />} />
//               <Route path="/weather" element={<WeatherRecommendationDisplay />} />
//               <Route path="/liked" element={<LikedMovies />} />
//               <Route path="/history" element={<History />} />
//               <Route path="/play/:id" element={<Play />} />
//               <Route path="/play-together/:id" element={<PlaySharedMovie />} /> 
