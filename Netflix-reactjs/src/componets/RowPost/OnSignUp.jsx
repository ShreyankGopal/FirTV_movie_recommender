...
function OnSignUp(props) {
  ...
  const { title, url, onMovieClick, selectedMovies } = props;
                ...
                >
                  ...
                  <div className="content pt-16">
                    <Fade bottom duration={300}>
                      <div className="group flex transition ml-3 ease-in-out delay-150">
                        <div
                          onClick={() => playMovie(obj)}
                          onMouseEnter={() => setshouldPop(false)}
                          onMouseLeave={() => setshouldPop(true)}
                          className="hidden group-hover:hidden text-white w-9 h-9 border-[2px] rounded-full p-2 mr-1 backdrop-blur-[2px] shadow-md ease-linear transition-all duration-150 hover:text-black hover:bg-white"
                        >
                          <svg
                        ...
                        <div
                          ...
                          onMouseEnter={() => setshouldPop(false)}
                          onMouseLeave={() => setshouldPop(true)}
                          className="hidden group-hover: hidden text-white w-9 h-9 border-[2px] rounded-full p-2 mr-1 backdrop-blur-[1px] shadow-md ease-linear transition-all duration-150 hover:text-black hover:bg-white"
                        >
                          <svg
                            xmlns="http://www.w3.org/2000/svg"
                            fill="none"
