...
function WeatherGenreChart({ data ,weatherLabel,
  weatherEmoji,
  slotLabel,
  slotEmoji,
  animationData,}) {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col md:flex-row items-center justify-between max-w-8xl mx-auto">
        ...
        <div className="md:w-1/2 w-full text-center space-y-4 mb-8 md:mb-0">
          {animationData && (
            <div className="w-32 h-32 mx-auto md:mx-12 mb-4" style={{marginLeft:`100px`}}>
              <Lottie animationData={animationData} loop />
            </div>
          )}
          <h1 className="text-4xl font-bold flex items-center gap-2" style={{paddingLeft:`20px`}}>
          ...
          <p className="text-lg text-gray-300" >
            We’ve analyzed the weather—here are the genres that fit a {weatherLabel} {slotLabel} best.
          </p>
        </div>
        {/* Left side: Text */}
        {/* <div className="md:w-1/2 w-full text-left space-y-6">
          <h2 className="text-3xl md:text-4xl font-semibold text-white">
            We've analyzed the weather — and picked these just for you.
          </h2>
          <p className="text-lg text-gray-300">
            The weather matters. So we took a moment to understand it — and in return, we’ve gathered a thoughtful lineup of films we believe you’ll connect with.
...
export default WeatherGenreChart;